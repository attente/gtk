...
static void
gtk_spin_button_get_panel_size (GtkCssGadget   *gadget,
                                GtkOrientation  orientation,
                                gint            for_size,
                                gint           *minimum,
                                gint           *natural,
...
static gboolean
gtk_spin_button_draw_panel (GtkCssGadget *gadget,
                            cairo_t      *cr,
                            int           x,
                            int           y,
                            int           width,
                            ...
                            gpointer      data)
{
  ...
  _gtk_icon_helper_set_window (icon_helper, gtk_widget_get_window (widget));
  _gtk_icon_helper_set_use_fallback (icon_helper, TRUE);

  if (gadget == priv->down_button)
    {
      gtk_style_context_save_to_node (context, gtk_css_gadget_get_node (priv->down_button));
      _gtk_icon_helper_set_icon_name (icon_helper, "list-remove-symbolic", GTK_ICON_SIZE_MENU);
    }
  else
    {
      gtk_style_context_save_to_node (context, gtk_css_gadget_get_node (priv->up_button));
...
gtk_spin_button_init (GtkSpinButton *spin_button)
{
  ...
  priv->down_button = gtk_css_custom_gadget_new ("button",
                                                 GTK_WIDGET (spin_button),
                                                 NULL,
                                                 NULL,
                                                 gtk_spin_button_get_panel_size,
                                                 NULL,
                                                 gtk_spin_button_draw_panel,
                                                 NULL,
                                                 NULL);
  ...
  priv->up_button = gtk_css_custom_gadget_new ("button",
                                               GTK_WIDGET (spin_button),
                                               NULL,
                                               NULL,
                                               gtk_spin_button_get_panel_size,
