...
gtk_check_button_init (GtkCheckButton *check_button)
{
  ...
  priv->gadget = gtk_css_custom_gadget_new_for_node (widget_node,
                                                     ...
                                                     gtk_check_button_get_content_size,
                                                     gtk_check_button_allocate_contents,
                                                     gtk_check_button_render_contents,
                                                     NULL,
                                                     NULL);
...
static gboolean
gtk_check_button_render_contents (GtkCssGadget *gadget,
                                  cairo_t      *cr,
                                  int           x,
                                  int           y,
                                  int           width,
...
static void
gtk_check_button_get_content_size (GtkCssGadget   *gadget,
                                   GtkOrientation  orientation,
                                   int             for_size,
                                   int            *minimum,
                                   int            *natural,
  ...
  if (orientation == GTK_ORIENTATION_HORIZONTAL)
  ...
  else
    {
      if (gtk_toggle_button_get_mode (GTK_TOGGLE_BUTTON (widget)))
        ...
        GTK_WIDGET_CLASS (gtk_check_button_parent_class)->get_preferred_height_and_baseline_for_width (widget, for_size,
                                                                                                       minimum, natural,
...
static void
gtk_check_button_allocate_contents (GtkCssGadget        *gadget,
                                    const GtkAllocation *allocation,
                                    int                  baseline,
                                    GtkAllocation       *out_clip,
                                    gpointer             unused)
