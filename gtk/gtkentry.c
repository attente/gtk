...
static gboolean     gtk_entry_render_contents          (GtkCssGadget        *gadget,
                                                        ...
                                                        gint                 height,
                                                        gpointer             data);
static void         gtk_entry_get_icon_size            (GtkCssGadget        *gadget,
                                                        GtkOrientation       orientation,
                                                        gint                 for_size,
                                                        gint                *minimum,
                                                        gint                *natural,
                                                        ...
                                                        gint                *natural_baseline,
                                                        gpointer             data);
static gboolean     gtk_entry_render_icon              (GtkCssGadget        *gadget,
                                                        cairo_t             *cr,
                                                        gint                 x,
                                                        gint                 y,
                                                        gint                 width,
...
static void
gtk_entry_get_icon_size (GtkCssGadget   *gadget,
                         GtkOrientation  orientation,
                         gint            for_size,
                         gint           *minimum,
                         gint           *natural,
