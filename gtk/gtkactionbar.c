...
static gboolean
gtk_action_bar_render_contents (GtkCssGadget *gadget,
                                cairo_t      *cr,
                                int           x,
                                int           y,
                                int           width,
...
static void
gtk_action_bar_allocate_contents (GtkCssGadget        *gadget,
...
static void
gtk_action_bar_get_content_size (GtkCssGadget   *gadget,
...
gtk_action_bar_init (GtkActionBar *action_bar)
{
  ...
  priv->gadget = gtk_css_custom_gadget_new_for_node (widget_node,
                                                     ...
                                                     gtk_action_bar_get_content_size,
                                                     gtk_action_bar_allocate_contents,
