                       ...
                       gpointer                prepare_func_data)
{
  ...
  if (capabilities & GDK_SEAT_CAPABILITY_POINTER)
    {
      status = gdk_device_grab (wayland_seat->master_pointer, window,
                                GDK_OWNERSHIP_NONE, owner_events,
                                GDK_ALL_EVENTS_MASK, cursor,
                                evtime);
  ...
  if (capabilities & GDK_SEAT_CAPABILITY_TOUCH)
    {
      status = gdk_device_grab (wayland_seat->touch_master, window,
                                GDK_OWNERSHIP_NONE, owner_events,
                                GDK_ALL_EVENTS_MASK, NULL,
                                evtime);
  ...
  if (capabilities & GDK_SEAT_CAPABILITY_KEYBOARD)
    {
      status = gdk_device_grab (wayland_seat->master_keyboard, window,
                                GDK_OWNERSHIP_NONE, owner_events,
                                GDK_ALL_EVENTS_MASK, NULL,
                                evtime);
  ...
  if (capabilities & GDK_SEAT_CAPABILITY_KEYBOARD)
    gdk_device_ungrab (wayland_seat->master_keyboard, evtime);

 fail_keyboard:
  if (capabilities & GDK_SEAT_CAPABILITY_TOUCH)
    gdk_device_ungrab (wayland_seat->touch_master, evtime);

 fail_touch:
  if (capabilities & GDK_SEAT_CAPABILITY_POINTER)
    gdk_device_ungrab (wayland_seat->master_pointer, evtime);
...
gdk_wayland_seat_ungrab (GdkSeat *seat)
{
  ...
  if (wayland_seat->master_pointer)
    gdk_device_ungrab (wayland_seat->master_pointer, GDK_CURRENT_TIME);
  if (wayland_seat->master_keyboard)
    gdk_device_ungrab (wayland_seat->master_keyboard, GDK_CURRENT_TIME);
  if (wayland_seat->touch_master)
    gdk_device_ungrab (wayland_seat->touch_master, GDK_CURRENT_TIME);
}
				      ...
				      struct wl_seat   *wl_seat)
{
  ...
  seat = g_object_new (GDK_TYPE_WAYLAND_SEAT, NULL);
  seat->id = id;
